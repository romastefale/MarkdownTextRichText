...
- 2026-09-15 20:17 UTC — evolução `feat/mdtxtrt-accent-settings` aplicada sobre `release/mdtxtrt-final-v1`: controles Rich corrigidos, seletor normal/H1–H6 com preservação de conteúdo e seleção, exclusão por menu com confirmação/desfazer, SVGs consistentes e preferência pessoal de sete cores sincronizada entre bot e Mini App. A versão anterior foi preservada.
- 2026-09-15 — finalização `release/mdtxtrt-final-v2`: parte exatamente de `feat/mdtxtrt-accent-settings`, preserva todas as versões anteriores e encerra a mecânica temporária de transporte. `.checkpoint`, `.release` e os workflows temporários de materialização/aplicação são removidos da árvore final; código de produto, testes e documentação da aparência v2 permanecem. Issue #15 e PR da v2 registram o fechamento, sem merge automático.
